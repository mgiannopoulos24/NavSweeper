...
<div class="wrap">
	...
	<?php else : ?>
		...
		<?php if ( ! $menu_items ) : ?>
			<div class="card navsweeper-empty-menu">
		...
		<?php else : ?>
			<form method="post" id="navsweeper-form" action="<?php echo esc_url( admin_url( 'themes.php?page=navsweeper-bulk-delete&menu_id=' . $selected_menu_id ) ); ?>">
				...
				<div class="navsweeper-action-bar">
					...
					<!-- Move Section -->
					<div class="navsweeper-move-section">
						<strong>Bulk Move Menu Items</strong>
						<div class="navsweeper-move-section-inner">
							<label for="destination_menu_id">Move selected to:</label>
					...
					<!-- Bulk Edit Section -->
					<div class="navsweeper-bulk-edit-section">
						<strong>Bulk Edit Menu Items</strong>
			...
			<!-- Bulk Edit Modal -->
			<div id="navsweeper-bulk-edit-modal" class="navsweeper-modal">
				<div class="navsweeper-modal-content">
					...
					<form method="post" id="navsweeper-bulk-edit-form" action="<?php echo esc_url( admin_url( 'themes.php?page=navsweeper-bulk-delete&menu_id=' . $selected_menu_id ) ); ?>">
						...
						<div class="navsweeper-modal-body">
							...
							<!-- Label Field -->
							<div class="navsweeper-edit-field">
								<label class="navsweeper-label-flex">
									<input type="checkbox" name="bulk_edit_fields[]" value="label" class="navsweeper-field-checkbox">
									<strong>Label (Link Text)</strong>
								</label>
								<input type="text" name="bulk_edit_label" class="regular-text" placeholder="New label for all selected items">
							</div>
							...
							<div class="navsweeper-edit-field">
								...
								<input type="text" name="bulk_edit_css_classes" class="regular-text" placeholder="class1 class2 class3">
							...
							<div class="navsweeper-edit-field">
								...
								<textarea name="bulk_edit_description" class="large-text" rows="3" placeholder="Description for menu items"></textarea>
							</div>
						</div>
			...
			<!-- Add Menu Item Modal -->
			<div id="navsweeper-add-item-modal" class="navsweeper-modal">
				<div class="navsweeper-modal-content">
					<div class="navsweeper-modal-header">
					...
					<form method="post" id="navsweeper-add-item-form" action="<?php echo esc_url( admin_url( 'themes.php?page=navsweeper-bulk-delete&menu_id=' . $selected_menu_id ) ); ?>">
						...
						<div class="navsweeper-modal-body">
							...
							<!-- Label Field -->
							<div class="navsweeper-edit-field">
								<label class="navsweeper-label-block">
									<strong>Label (Link Text) <span class="navsweeper-required-asterisk">*</span></strong>
								</label>
								<input type="text" name="new_item_label" id="new_item_label" class="regular-text" placeholder="Menu item label" required>
							</div>

							<!-- URL Field -->
							<div class="navsweeper-edit-field">
								<label class="navsweeper-label-block">
									<strong>URL <span class="navsweeper-required-asterisk">*</span></strong>
								</label>
							...
							<div class="navsweeper-edit-field">
								...
								<input type="text" name="new_item_css_classes" id="new_item_css_classes" class="regular-text" placeholder="class1 class2 class3">
								<p class="description">Separate multiple classes with spaces</p>
							</div>
							...
							<div class="navsweeper-edit-field">
								...
								<textarea name="new_item_description" id="new_item_description" class="large-text" rows="3" placeholder="Description for menu item"></textarea>
							</div>
						</div>
